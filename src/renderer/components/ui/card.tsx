...
export const Card = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-lg border border-border/70 bg-card/80 text-card-foreground shadow-[0_1px_0_hsl(0_0%_100%/0.04)_inset,0_10px_30px_-15px_hsl(0_0%_0%/0.6)] backdrop-blur',
        className
      )}
      {...props}
    />
